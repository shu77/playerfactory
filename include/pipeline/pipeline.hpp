...
namespace mediapipeline
{
  ...
  public:
    ...
    // = 0;
    /*virtual */ gboolean pause ();
    // = 0;
    /*virtual */ gboolean stop ();
    // = 0;
    /*virtual */ gboolean seek (gint64 ms);
    // = 0;
...
//end seek,trick
    ...
    /*virtual */ gint64 duration () const;
    // = 0;
    /*virtual */ gint64 position () const;
    // = 0;
    /*virtual */ gint volume () const;
    // = 0;
    /*virtual */ gboolean isMuted () const;
    // = 0;
    /*virtual */ gboolean isAudioAvailable () const;
    // = 0;
    /*virtual */ gboolean isVideoAvailable () const;
    // = 0;
    /*virtual */ gboolean isSeekable ();
    // = 0;
    /*virtual */ gboolean isSeekable (gpointer data);
    // = 0;
